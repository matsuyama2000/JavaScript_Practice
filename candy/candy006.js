...
function findDifferent(numbers) {
  ...
  // filter: the index of its first occurrence === that of its last occurrence
  const difNum = numbers.filter((e, index) => (numbers.indexOf(e) === index) && (numbers.lastIndexOf(e) === index))
  return difNum;
}
